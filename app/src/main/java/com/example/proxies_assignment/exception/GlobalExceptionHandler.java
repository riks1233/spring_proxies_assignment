...
public class GlobalExceptionHandler {
    ...
    public Response<Null> handleUnexpectedException(
        Exception exception, WebRequest request
    ) {
        // End users should not be able to see unexpected server-side error messages.
        return new ErrorMessageResponse(
            "Oops! Something unexpected happened. Could not resolve request.",
    ...
    public Response<Map<String, String>> handleValidationException(
        ...
        return new ErrorResponse<Map<String, String>>(
    ...
    // Handle generic error exceptions (thrown manually to send a message to the
    // user.)
    @ExceptionHandler(GenericErrorException.class)
    public Response<Null> handleUnexpectedException(
        GenericErrorException exception,
        WebRequest request
    ) {
        return new ErrorMessageResponse(
    ...
    public Response<Null> handleParsingException(
    ...
    public Response<Null> handleParsingException(
        ...
        return new ErrorMessageResponse(
            String.format("Violated constraint: %s", constraintName),
            request.getDescription(false)
        );
    }
